...
import './Navbar.css'
import logo  from '../assets/assets/devcrafts.in.png'
...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      <img className='main_logo' src={logo} alt="" width="60px" />
      ...
      <ul ref={menuRef} className='nav-menu'>
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#Footerx'><p onClick={()=>setMenu("My_project")}>My Project</p></AnchorLink>{menu==="my_project"?<img src={underline} alt=''/>:<></>}</li>
